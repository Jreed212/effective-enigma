...
(function(){
  ...
  function warmupSetsFor(lift,working){
    working=+working||0;
    if(!working)return [];
    // Keep warm-ups useful, not fatiguing. Moderate working weights get two ramps;
    // only genuinely heavier work gets a third short ramp.
    let scheme=working<225
      ? [[.45,8,'Warm-up'],[.70,3,'Ramp']]
      : [[.40,8,'Warm-up'],[.60,4,'Build'],[.78,2,'Ramp']];
    const out=[];
